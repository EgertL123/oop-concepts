...
class Square extends Shape{
    ...
    getArea(){
        return Math.round(this.side * this.side)
    }

    print(){
        return `Circle (a: ${this.side}, color: ${this.color}).` 
    }
}
...
class Rectangle extends Shape{
    ...
    getArea(){
        return Math.round(this.width * this.length)
    }
...
const square1 = new Square('green', 5) // Square
